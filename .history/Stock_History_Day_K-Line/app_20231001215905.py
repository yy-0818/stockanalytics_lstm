...
def load_prediction_model():
    model = load_model(r'.\Stock_History_Day_K-Line\Model\apple_lstm_model.h5')  # 替换为你的模型文件
    return model
...
# 绘制实际股价和预测股票价格
ax.plot(Y_test, color="red", label="stock actual price")
ax.plot(X_test_pred_price, color="blue", label="stock price prediction")
