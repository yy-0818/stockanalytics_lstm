...
def main():
    ...
    # 添加第一个线条
    fig.add_trace(go.Scatter(x=len(stock_data), y=X_test_pred_price, mode='lines', name='prediction'))

    # 添加第二个线条
    fig.add_trace(go.Scatter(x=len(stock_data), y=Y_test, mode='lines', name='val'))
