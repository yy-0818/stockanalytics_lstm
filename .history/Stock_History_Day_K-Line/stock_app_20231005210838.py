...
label_stock_dict = {"Stock Name","Stock Code","Date","Open","Clos"e,"High","Low","Volume","Turnover,Amplitude","Change Percent","Change Amount","Turnover Rate"}
...
def interactive_galaxies(df):
    ...
    # jointplot = sns.jointplot(x='开盘', y='收盘', data=selected_stock_df, kind='scatter', ax=ax)
    # jointplot.set_axis_labels(f'{stock_name} - 开盘价', f'{stock_name} - 收盘价', fontsize=12)

    ax.scatter(selected_stock_df['开盘'], selected_stock_df['收盘'])
