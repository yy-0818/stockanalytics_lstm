...
def tell_me_more():
    ...
    # st.image(r'Stock_History_Day_K-Line\images\rnn.jpg', width=500, use_container_width=True, caption='循环神经网络结构图')

    image_width = 500   

    # 居中显示图像
    st.image(r'Stock_History_Day_K-Line\images\rnn.jpg', width=image_width, caption='Your Caption Here', use_column_width=True)
    st.markdown("""
