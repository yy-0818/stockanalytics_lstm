...
def tell_me_more():
    ...
    st.image(r'Stock_History_Day_K-Line\images\lstm.jpg', width=500, caption='LSTM 神经网络结构图')
    st.image(r'Stock_History_Day_K-Line\images\lstm_inside.jpg', width=500, caption='LSTM 神经网络内部结构')
    st.latex(
    """
