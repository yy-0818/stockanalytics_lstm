...
def tell_me_more():
    ...
    col2.image(r'Stock_History_Day_K-Line\images\rnn.jpg', width=600, caption='循环神经网络结构图')
    st.markdown("""
    ...
    col2.image(r'Stock_History_Day_K-Line\images\lstm.jpg', width=500, caption='LSTM 神经网络结构图')
